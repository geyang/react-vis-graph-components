...
var _getLinkKey = require('./utils/get-link-key');

var _getLinkKey2 = _interopRequireDefault(_getLinkKey);
  ...
  _createClass(Sankey, [{
    ...
    value: function render() {
      ...
      var linkWidths = links.reduce(function (hash, _ref5) {
        ...
        return _extends({}, hash, _defineProperty({}, (0, _getLinkKey2.default)(from, to), width));
      }, {});
      ...
      var nodeHash = orderedLinks.reduce(function (hash, _ref6) {
        ...
        return _extends({}, hash, (_extends4 = {}, _defineProperty(_extends4, from, _extends({}, hash[from], {
          from: [].concat(_toConsumableArray(hash[from] && hash[from].from ? hash[from].from : []), [(0, _getLinkKey2.default)(from, to)])
        })), _defineProperty(_extends4, to, _extends({}, hash[to], {
          to: [].concat(_toConsumableArray(hash[to] && hash[to].to ? hash[to].to : []), [(0, _getLinkKey2.default)(from, to)])
        })), _extends4));
      }, {});
      ...
      var linksWithCoords = orderedLinks.map(function (link, ind) {
        ...
        var linkProps = _objectWithoutProperties(_link$props, ['from', 'to', 'width', 'children']);

        var _getAnchorFromRectang = (0, _getAnchorFromRectangleNodes2.default)(from, nodesWithCoords, _getAnchorFromRectangleNodes.ANCHOR_CONSTANTS.TOPRIGHT);

        var x1 = _getAnchorFromRectang.x;
        var y1 = _getAnchorFromRectang.y;

        var _getAnchorFromRectang2 = (0, _getAnchorFromRectangleNodes2.default)(to, nodesWithCoords, _getAnchorFromRectangleNodes.ANCHOR_CONSTANTS.TOPLEFT);

        var x2 = _getAnchorFromRectang2.x;
        var y2 = _getAnchorFromRectang2.y;

        var _getWidthSums = (0, _getWidthSums3.default)(nodeHash, linkWidths, from, to, (0, _getLinkKey2.default)(from, to));
