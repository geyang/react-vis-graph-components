...
function splitHeadsFromRest() {
  ...
  var heads = nodes.filter(function (_ref) {
    ...
    return !links.find(function (_ref2) {
  ...
  var linksFrom = links.filter(function (_ref3) {
    ...
    return heads.find(function (_ref4) {
...
(function () {
  ...
  __REACT_HOT_LOADER__.register(splitHeadsFromRest, "splitHeadsFromRest", "src/utils/split-heads-from-rest.js");
})();
