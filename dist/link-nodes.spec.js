...
(function () {
  ...
  __REACT_HOT_LOADER__.register(string, 'string', 'src/link-nodes.spec.js');

  __REACT_HOT_LOADER__.register(HappySandwichMaker, 'HappySandwichMaker', 'src/link-nodes.spec.js');
})();
