...
(function () {
  ...
  __REACT_HOT_LOADER__.register(parseInt, 'parseInt', 'src/example/link-nodes-events.example.js');

  __REACT_HOT_LOADER__.register(NODES, 'NODES', 'src/example/link-nodes-events.example.js');

  __REACT_HOT_LOADER__.register(LINKS, 'LINKS', 'src/example/link-nodes-events.example.js');

  __REACT_HOT_LOADER__.register(HappySandwichMakerExample, 'HappySandwichMakerExample', 'src/example/link-nodes-events.example.js');
})();
