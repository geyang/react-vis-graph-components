    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        nodes.map(function (_ref) {
          ...
          var y = _ref.y;
          var name = _ref.name;
          return _react2.default.createElement(_circleNode2.default, { name: name, key: name,
            cx: x, cy: y, r: 10, stroke: 'black', strokeWidth: '0', fill: 'red' });
        }),
        links.map(function (_ref2) {
          var from = _ref2.from;
          var to = _ref2.to;
          return _react2.default.createElement(_straightConnector2.default, { from: from, to: to, key: from + '-' + to,
            strokeWidth: 2, color: 'rgba(24, 55, 55, 0.6)', paddingStart: 2,
            paddingEnd: 9, markerEndId: 'arrow' });
        })
      );
    }
  }]);
...
(function () {
  ...
  __REACT_HOT_LOADER__.register(NODES, 'NODES', 'src/example/link-graph-simple.example.js');

  __REACT_HOT_LOADER__.register(LINKS, 'LINKS', 'src/example/link-graph-simple.example.js');

  __REACT_HOT_LOADER__.register(HappySandwichMakerExample, 'HappySandwichMakerExample', 'src/example/link-graph-simple.example.js');
})();
