...
function RectangleNode(_ref) {
  ...
  var restProps = _objectWithoutProperties(_ref, ['name', 'x', 'y', 'width', 'height', 'margin', 'fill', 'stroke', 'strokeWidth', 'children']);
...
(function () {
  ...
  __REACT_HOT_LOADER__.register(_default, 'default', 'src/blocks/rectangle-node.js');
})();
