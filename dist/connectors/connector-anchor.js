...
(function () {
  ...
  __REACT_HOT_LOADER__.register(arrayOf, 'arrayOf', 'src/connectors/connector-anchor.js');

  __REACT_HOT_LOADER__.register(oneOf, 'oneOf', 'src/connectors/connector-anchor.js');

  __REACT_HOT_LOADER__.register(propTypes, 'propTypes', 'src/connectors/connector-anchor.js');

  __REACT_HOT_LOADER__.register(styleProps, 'styleProps', 'src/connectors/connector-anchor.js');

  __REACT_HOT_LOADER__.register(StraightConnector, 'StraightConnector', 'src/connectors/connector-anchor.js');
})();
